    ...
    return (
        ...
        >
            ...
            >
                ...
                <p>Because the model is run with 0.25 degree spatial resolution (~30 km), these data should only be used for regional analysis. This App is re-configured by Rajan Kumar Singh with help of environmental research done by ESRI.</p>
            </div>
        </Modal>
    )
};
